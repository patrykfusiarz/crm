           ...
           <div>
             ...
             <div className="mt-2">
               <div className="relative">
                 ...
                 >
                   <div className="w-full h-full flex items-center justify-center rounded-r-md border-l border-t border-r border-b border-gray-200 hover:bg-white transition-colors cursor-pointer"><svg className="h-4 w-4 text-gray-500 group-hover:text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                     {showPassword ? (
