...
// Force rebuild - tooltip fix
 ...
 return (
   <div className="h-full flex flex-col max-w-[2000px] mx-auto px-6 lg:px-17 pb-7">
     <div className="mb-8">
     ...
     {/* New Container */}
     <div className="mb-6">
       <div className="bg-white rounded-lg border border-gray-200 p-6 h-48 shadow-lg shadow-gray-200/50">
         <div className="flex h-full">
           <div className="flex-[50] pr-4">
             <div className="text-[48px] font-medium text-red-500">2</div>
             <div className="text-lg font-medium text-gray-900 mt-1">Overdue</div>
             <div className="text-lg text-gray-600">$36,000.00</div>
           </div>
           <div className="border-r border-gray-200"></div>
           <div className="flex-[25] px-4">
             <div className="text-[48px] font-medium text-gray-900">9</div>
             <div className="text-lg font-medium text-gray-900 mt-1">Due in next 7 days</div>
             <div className="text-lg text-gray-600">$165,000.00</div>
           </div>
           <div className="border-r border-gray-200"></div>
           <div className="flex-[25] pl-4">
             <div className="text-[48px] font-medium text-gray-900">20</div>
             <div className="text-lg font-medium text-gray-900 mt-1">Days left in May</div>
           </div>
         </div>
       </div>
     </div>
